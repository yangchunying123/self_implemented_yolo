...
from datas.voc import ImageTransfrom
...
class YOLODetector:
    def __init__(self,
        model_path, class_name_list=None, conf_thresh=0.1, prob_thresh=0.1, nms_thresh=0.5, gpu_id=0):

        os.environ["CUDA_VISIBLE_DEVICES"] = str(gpu_id)
        print("Loading YOLO model...")
        self.yolo = YOLOV1().cuda()
...
if __name__ == '__main__':
    ...
    out_path = 'result.png'
    model_path = 'results/Mar03_16-07-09/model_best.pth'
    gpu_id = 0
