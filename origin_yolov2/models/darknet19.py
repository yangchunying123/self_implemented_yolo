...
class DarkNet_19(nn.Module):
    ...
    def forward(self, x):
        c1 = self.conv_1(x) #[3, H, W] -> [32, H/2, W/2]
        c2 = self.conv_2(c1) #           ->[64, H/4, W/4]
        c3 = self.conv_3(c2) #            ->[128, H/8, W/8]
        c3 = self.conv_4(c3) #              ->[256, H/8, W/8]
        c4 = self.conv_5(self.maxpool_4(c3))  #     ->[256, H/16, W/16]->[512, H/16, W/16]
        c5 = self.conv_6(self.maxpool_5(c4))  #     ->[512, H/32, W/32]->[1024, H/32, W/32]
